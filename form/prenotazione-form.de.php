...
*/
	...
	<div id="prenotazioni">
						...
						<form action="prenotazioni.de.php" method="post" name="Prenotazioni">
						<div class = "esempio">
							<p>Für lange Reisen ist eine telefonische Vereinbarung notwendig. </p>
							<p>Die Felder mit * sind obligatorisch.</p>
						</div>
						
						<table>
						
						<tr>
							<td class="Campo">Tag :</td>
							<td>
								<select name="giorno">
								<option>1</option>
								<option>2</option>
						...
						<tr>
						<td class="Campo">Monat :</td>
							<td>
								<select name="mese">
								<option>Januar</option>
								<option>Febrar</option>
								<option>März</option>
								<option>April</option>
								<option>Mai</option>
								<option>Juni</option>
						...
						<tr>
							<td class="Campo">Telefonnummer* : <div class = "esempio"> (ex: 333/123456789)</div></td>
							<td><input name="telefono" type="text" 
							value="<?php echo $FIELDS['telefono']->val ?>" size="30" maxlength="40"/></td>
						</tr>
						
						<tr>
						<td class="Campo" >Notiz :</td>
							<td>
						...
						<tr>
								<td>
								<p class="informativa"><b> Datenschutzgesetz*:</b></p></td>
								<td>
