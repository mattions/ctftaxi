...
*/
	...
	<div id="prenotazioni">
						...
						<form action="prenotazioni.en.php" method="post" name="Prenotazioni">
						<div class = "esempio">
							<p>For very long trips a telephon accord is required </p>
						...
						<tr>
							<td class="Campo">Phone* : <div class = "esempio"> (ex: 333/123456789)</div></td>
						...
						<tr>
								<td>
								<p class="informativa"><b> Law regarding the protection of personal data*:</b></p></td>
								<td>
