	...
	?>
		<div class="pre-menu">
			<div id="menu">
	            ...
	            <li><a id="activelink">Estimate</a></li>
	...
	<div id = "colonna_centrale">
		<div id="contenuti">
			<div id="presentazione">
				<h1>Calculate the Estimate</h1>
				<?php
				#	include("./include/enfasi_prenotazione.inc.en.php");
				?>
					<p>The <img alt="ctf" src="immagini/ctf-logo-small.png" />, is always careful to the demand of its clients. Its aim is to furnish
					the possibility to calculate the estimate of a trip.</p>
					<p>Do you want to make sure if your trip is one of those resulting the most required by our customers? This is 
					possible choosing it simply from the pull-down menu.</p>
					<p>Should your trip not be among these, don't hesitate to send an e-mail to get a 
					<strong>free estimate without obligation</strong> to <a href="mailto:info@ctftaxi.it">info@ctftaxi</a>.</p>
					<p>The proposte estimate is between a maximum and a minum value to consider the variability of 
...
if( !$form->isSent || !$form->isValid() )
{
    /*
		...
		*/
    $form->display('form/preventivo-form.en.php') ;
