...
if(!defined('IN_PHPSTATS')) die('Php-Stats internal file.');
      ...
      if(isset($_POST['mounth1'])) $mounth1=addslashes($_POST['mounth1']);
       else{ if(isset($_GET['mounth1'])) $mounth1=addslashes($_GET['mounth1']); else $mounth1='last'; }
      if(isset($_POST['year1'])) $year1=addslashes($_POST['year1']);
       else{ if(isset($_GET['year1'])) $year1=addslashes($_GET['year1']); else $year1='last'; }
      if(isset($_POST['mounth2'])) $mounth2=addslashes($_POST['mounth2']);
       else{ if(isset($_GET['mounth2'])) $mounth2=addslashes($_GET['mounth2']); else $mounth2='last'; }
      if(isset($_POST['year2'])) $year2=addslashes($_POST['year2']);
       else{ if(isset($_GET['year2'])) $year2=addslashes($_GET['year2']); else $year2='last'; }
      if(isset($_POST['view_graphics'])) $view_graphics=addslashes($_POST['view_graphics']);
      else{ if(isset($_GET['view_graphics'])) $view_graphics=addslashes($_GET['view_graphics']); else $view_graphics=0; }
...
$return=
"<br><br><center><form action='./admin.php?action=compare' method='POST' name=form1><span class='testo'>$string[compare_comp]</span>".
'<SELECT name=mounth1>';
