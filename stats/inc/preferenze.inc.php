...
function preferenze(){
global $db,$is_loged_in,$opzioni,$error,$style,$modulo,$string,$pref,$varie,$option,$option_new,$php_stats_esclusion,$whatview,$newstyle,$scstyle,$scdigits,$phpstats_title,$NowritableServer;
$return='';
...
if($opzioni=='applica'){
    ...
    "&nbsp;&nbsp;<span class=\"tabletextA\"><a href=\"admin.php?action=unlock_pages\">$pref[unlocked_pages]</a></td></tr>".
        ...
        "<a name=\"scriptgenerator\"></a><table border=\"0\" $style[table_header] width=\"90%\" align=\"center\" >".
        ...
        for($i=0;$i<5;++$i)$return.="<option value=\"$i\"".($whatview==$i ? ' selected' : '').">".$pref["cs_view_$i"]."</option>";
        $return.=
        "</select></td></tr>".
        ...
        "</td></tr>".
        "</table>".
        "<center><textarea name=\"scriptcode\" cols=\"100%\" rows=\"3\">";
        ...
        "<tr><td bgcolor=$style[table_bgcolor]><center><span class=\"tabletextA\">$pref[refresh_desc]</span><br><br><input type=\"Submit\" value=\"$pref[refresh_go]\"></center><br></td></tr>".
        "</form></table>";
}
return($return);
}
