...
function esclusioni() {
global $db,$is_loged_in,$opzioni,$error,$style,$string,$pref,$option,$option_new,$php_stats_esclusion,$NowritableServer,$phpstats_title;
...
if(substr($opzioni,0,3)==='exc'){
        ...
        "\n\t<tr><td align=\"right\" bgcolor=$style[table_bgcolor]><span class=\"tabletextA\">$string[esclude_fol]</span></td><td bgcolor=$style[table_bgcolor]><textarea name=\"option_new\" cols=\"60\" rows=\"4\">$option[exc_fol]</textarea></td></tr>".
        ...
        "\n\t<tr><td align=\"right\" bgcolor=$style[table_bgcolor]><span class=\"tabletextA\">$string[esclude_ips]</span></td><td bgcolor=$style[table_bgcolor]><textarea name=\"option_new\" cols=\"60\" rows=\"4\">$option[exc_sip]</textarea></td></tr>".
        "\n\t<tr><td bgcolor=$style[table_bgcolor] colspan=\"2\"><center><input type=\"Submit\" value=\"$string[esclude_salva]\"></center></td></tr>".
        "\n</table>\n</form>";
        //Exclused DIP
        $return.=
        ...
        "\n\t<tr><td align=\"right\" bgcolor=$style[table_bgcolor]><span class=\"tabletextA\">$string[esclude_ipd]</span></td><td bgcolor=$style[table_bgcolor]><textarea name=\"option_new\" cols=\"60\" rows=\"4\">$option[exc_dip]</textarea></td></tr>".
        "\n\t<tr><td bgcolor=$style[table_bgcolor] colspan=\"2\"><center><input type=\"Submit\" value=\"$string[esclude_salva]\"></center></td></tr>".
        "\n</table>\n</form>";
}
return($return);
