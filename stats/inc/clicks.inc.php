...
if(@mysql_num_rows($result)>0)
  ...
  while($row=@mysql_fetch_row($result))
    ...
    "<td bgcolor=$style[table_bgcolor]><span class=\"tabletextA\"><center><a href=\"javascript:link('$id');\" onClick=\"link('$id')\">$id</a></center></span></td><td bgcolor=$style[table_bgcolor]><span class=\"tabletextA\">&nbsp;<b>$clicks_log_accessi</b></span></td><td bgcolor=$style[table_bgcolor]><center>".checkfile($clicks_log_url)."</center></td></tr>";
    }
  ...
  "<tr><td bgcolor=$style[table_bgcolor]><center><textarea name=\"downcode\" cols=\"100\" rows=\"2\">$string[click_downcli]</textarea></center></form></td></tr>".
  "</table>";
  }
