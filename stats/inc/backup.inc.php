...
if($mode!='restore')
  ...
  "<br><center><span class=\"tabletextA\">$string[backup_mode]</span>&nbsp<select name=\"data\">".
  "<option value=\"YES\">$string[backup_mode_1]</option>".
  "<option value=\"NO\">$string[backup_mode_2]</option>".
  "</select></center><br>".
