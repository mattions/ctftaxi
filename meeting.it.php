...
<div id="contenitore">
	<div  id="bandiere">
		<a href="meeting.it.php"><img class="allineamento" width="68" height="43" title="Italiano" alt="Italiano" src="immagini/bandiera-italiana.gif" /></a><a href="meeting.en.php"><img class="allineamento" width="68" height="43" title="English" alt="English" src="immagini/bandiera-inglese.gif" /></a>
		<a href="meeting.en.php"><img class="allineamento" width="68" height="43" title="Français" alt="Français" src="immagini/bandiera-francese.gif" /></a><a href="meeting.en.php"><img class="allineamento" width="68" height="43" title="Deutsch" alt="Deutsch" src="immagini/bandiera-tedesca.gif" /></a>
		</div>
	<?php
	/*
	...
	*/
	...
	?>
		<div class="pre-menu">
			<div id="menu">
	        	...
	        	height="11px" /></sup></li>
	        		<li><a id="activelink" href="meeting.it.php">Meeting</a>
	        	<sup><img src="immagini/new.gif" alt="new" width="24px" 
	        	height="11px" /></sup></li>
	        </ul>
				</div>
	...
	<div id = "colonna_centrale">
		<div id="contenuti">
			...
			<div id="meeting">
			<h1>Meeting</h1>
			 <p>La <img alt="ctf" src="immagini/ctf-logo-small.png" /> &egrave; in grado di organizzarvi 
			 ogni tipo di <b>Trasferimento</b> verso qualsiasi tipo di manifestazione:</p>
			 <p><div class="enfasi_dettaglio">CONVEGNI,MEETING, FIERE, EVENTI SPECIALI</div>, garantendovi 
			 la massima qualit&agrave; e disponibilit&agrave; di mezzi.</p>
				<p>Per ogni tipo di informazioni rivolgersi al numero <b>334 154 88 99</b>  o via mail a 
				<a href="mailto:info@ctftaxi.it">info@ctftaxi.it</a></p>
			</div>
		</div>	
		</div>
