...
<div id="footer">
				...
				<a href="http://jigsaw.w3.org/css-validator/validator?uri=http://www.ctftaxi.it">
				<img class =" footer" width="88px" height="31px" alt="Valid CSS!" title="Valid CSS!" 
				src="immagini/valid-css.jpeg" /></a>

				
				
				<h4> &copy; 2005 - 2011 ctftaxi.it  P.IVA 02218920425</h4>
