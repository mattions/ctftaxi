	...
	*/
	...
	?>
		<div class="pre-menu">
			<div id="menu">
	        	...
	        	height="11px" /></sup></li>
		        	<li><a id="activelink" href="meeting.en.php">Meeting</a>
		        	<sup><img src="immagini/new.gif" alt="new" width="24px" 
		        	height="11px" /></sup></li>
	        </ul>
				</div>
	...
	<div id = "colonna_centrale">
		<div id="contenuti">
			...
			<div id="meeting">
						<h1>Meeting</h1>
			 <p><img alt="ctf" src="immagini/ctf-logo-small.png" /> is able to organize every type 
			 of <b>Transfer</b> towards whichever type of manifestation:</p>
			 <p><div class="enfasi_dettaglio">MEETINGS, SPECIAL EVENTS, and more</div>.</p>
				<p>FOr information call the number <b>334 154 88 99</b>  or send us an e-mail  
